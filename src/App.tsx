...
const App = () => {
  ...
  return (
    <div
        ...
        Malla Interactiva – Química y Farmacia – U. de Chile
      </h1>
      ...
      <div className="flex justify-center">
        ...
        <div className="grid grid-rows-[auto_auto_1fr] gap-4">
          {/* Fila de Años */}
          <div className="grid grid-cols-11 gap-x-6 gap-y-6">
          ...
          {[
              ...
              <div
                key={index}
                className={`${modoOscuro ? "bg-purple-700 text-white" : "bg-pink-300 text-white"} text-center font-bold py-2 rounded-md text-sm ${colSpan === 1 ? 'col-span-1' : colSpan === 2 ? 'col-span-2' : ''}`}
          ...
          <div className="grid grid-cols-11 gap-2">
            {romanos.map((r, i) => (
              <div
                key={`romano-${i}`}
                className={`${modoOscuro ? "bg-purple-600 text-white" : "bg-pink-200"} text-center font-bold py-1 rounded-md shadow text-sm`}
          ...
          <div className="grid grid-cols-11 gap-4">
            {Array.from({ length: 11 }).map((_, semestreIndex) => {
              ...
              return (
                <div key={semestre} className="flex flex-col gap-12">
                  {cursos.map(curso => {
                    ...
                    return (
                      ...
                      <button
                          className={`relative w-full max-w-[8rem] h-20 flex flex-col justify-center items-center rounded-md shadow text-center text-[11px] font-medium
